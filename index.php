					...
					<div class="portfolio-wrapper">						
						<div id="berryface-container" class="port-piece-container">
							...
							<div class="portfolio__div--port-piece-text-container" id="berryface-port-piece-text">
								<h3>BerryFace</h3>
								<p>BerryFace is an interface for a raspberry pi. BerryFace will soon get data from Firebase.</p>
								...
								<div class="portfolio__div--links-container">
									...
									<a tabindex="0" id="portfolio__a-berryFace-GH" class="portfolio__links port-view-GH" href="https://github.com/lizkovalchuk/berryface-v2" target="_blank">React Repo</a>								
									<a tabindex="0" id="portfolio__a-berryFace-GH2" class="portfolio__links port-view-GH" href="https://github.com/lizkovalchuk/Python-BerryFace" target="_blank">Python Repo</a>								
								</div>
							</div>
						</div>
